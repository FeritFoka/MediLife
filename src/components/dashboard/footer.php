<?php
    ...
    Web aplikacija je izrađena uz pomoć sljedećih tehnologija:
    <ul>
        <li>HTML5</li>
        <li>PHP</li>
        <li>Sass</li>
    ...
    $madeByItem->template('Web aplikaciju su napravili Stjepan Mrganić, Petra Radočaj i Dominik Ričko.');
