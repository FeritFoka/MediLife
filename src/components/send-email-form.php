        ...
        <div class="contact-info">
          ...
          <div>
            <div class="medilife-contact-info">
              <img src="./images/location_icon.png" class="contact-icon" alt="Medilife location icon" />
              <p aria-readonly="true">Cara Hadrijana 10b, Osijek</p>
            </div>
            <div class="medilife-contact-info">
              <img src="./images/email_icon.png" class="contact-icon" alt="Medilife email address icon" />
              <p aria-readonly="true">contact@medilife.com</p>
            </div>
            <div class="medilife-contact-info">
              <img src="./images/phone_icon.png" class="contact-icon" alt="Medilife phone icon" />
