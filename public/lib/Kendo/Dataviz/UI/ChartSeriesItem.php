...
//>> Properties
    ...
    * @return \Kendo\Dataviz\UI\ChartSeriesItem
    */
    public function autoFit($value) {
        return $this->setProperty('autoFit', $value);
    }
    ...
    * @param \Kendo\Dataviz\UI\ChartSeriesItemMedian|array $value
    * @return \Kendo\Dataviz\UI\ChartSeriesItem
    */
    public function median($value) {
        return $this->setProperty('median', $value);
    }
    ...
    * @param \Kendo\Dataviz\UI\ChartSeriesItemMean|array $value
    * @return \Kendo\Dataviz\UI\ChartSeriesItem
    */
    public function mean($value) {
        return $this->setProperty('mean', $value);
    }
    ...
    * @param \Kendo\Dataviz\UI\ChartSeriesItemWhiskers|array $value
    * @return \Kendo\Dataviz\UI\ChartSeriesItem
    */
    public function whiskers($value) {
        return $this->setProperty('whiskers', $value);
    }
